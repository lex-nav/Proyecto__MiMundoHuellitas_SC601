...
namespace MiMundoHuellitas.EF
{
    ...
    public partial class MiMundoHuellitasEntities : DbContext
    {
        ...
        public virtual DbSet<MH_PlanillaPeriodoConfig_TB> MH_PlanillaPeriodoConfig_TB { get; set; }
        ...
        public virtual int usp_MH_CerrarMarcacionesAbiertas()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_MH_CerrarMarcacionesAbiertas");
        }
    
        public virtual int usp_MH_CerrarMarcacionesAbiertasAnteriores()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_MH_CerrarMarcacionesAbiertasAnteriores");
        }
    
        public virtual ObjectResult<usp_MH_CrearSiguientePlanilla_Result> usp_MH_CrearSiguientePlanilla(Nullable<long> idPlanillaCerrada)
        {
            var idPlanillaCerradaParameter = idPlanillaCerrada.HasValue ?
                new ObjectParameter("IdPlanillaCerrada", idPlanillaCerrada) :
                new ObjectParameter("IdPlanillaCerrada", typeof(long));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_MH_CrearSiguientePlanilla_Result>("usp_MH_CrearSiguientePlanilla", idPlanillaCerradaParameter);
        }
    }
}
